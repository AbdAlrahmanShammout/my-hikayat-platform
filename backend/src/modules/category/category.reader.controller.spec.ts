...
import { CategoryReaderController } from './category.reader.controller';
...
describe('CategoryReaderController', () => {
  let categoryReaderController: CategoryReaderController;
  ...
  beforeEach(async () => {
    ...
    const moduleRef: TestingModule = await Test.createTestingModule({
      ...
      controllers: [CategoryReaderController],
      providers: [
    ...
    categoryReaderController = moduleRef.get(CategoryReaderController);
  });
  ...
  describe('listCategories', () => {
    it('maps pagination fields into the service', async () => {
      ...
      const actualResponse = await categoryReaderController.listCategories({
        limit: 10,
        offset: 0,
      });
