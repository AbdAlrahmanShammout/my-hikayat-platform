...
import { AuthorAnalyticsPage } from '@/modules/monetization/defs/author-analytics-service.defs';
import { BookEngagementResponse } from '@/modules/monetization/dto/response/model/book-engagement.response';

export class GetAuthorAnalyticsResponseDto {
  ...
  @ApiProperty({
    description: 'Total weighted engagement minutes across the owner books',
    example: 7,
  })
  ...
  constructor(result: AuthorAnalyticsPage) {
