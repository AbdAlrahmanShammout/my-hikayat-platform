...
export abstract class PlanRepository {
  ...
  abstract update(input: UpdatePlanRepoInput, context?: TransactionContext): Promise<PlanEntity>;
  ...
  abstract findByStripePriceId(stripePriceId: string): Promise<PlanEntity | null>;
