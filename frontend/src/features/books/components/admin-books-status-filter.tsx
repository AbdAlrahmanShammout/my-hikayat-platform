...
type AdminBooksStatusFilterProps = {
  readonly value: BookPublishingStatusFilter | undefined;
  readonly onChange: (value: BookPublishingStatusFilter | undefined) => void;
};

/**
 * Optional publishingStatus query for GET /admin/books.
 */
export function AdminBooksStatusFilter({
  value,
  onChange,
}: AdminBooksStatusFilterProps): JSX.Element {
  return (
    <div className="flex w-full max-w-xs flex-col gap-2">
      <Label htmlFor="publishing-status-filter">Publishing status</Label>
      <Select
