...
type AuthorBookDetailSummaryProps = {
  readonly book: components['schemas']['BookResponse'];
};

/**
 * Read-only book fields from GET /author/books/:id.
 */
export function AuthorBookDetailSummary({ book }: AuthorBookDetailSummaryProps): JSX.Element {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Book record</CardTitle>
      </CardHeader>
      <CardContent>
