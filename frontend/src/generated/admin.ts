...
export interface paths {
  ...
  "/admin/audit-logs": {
    get: {
      parameters: { query?: { limit?: number; offset?: number; actorUserId?: number; action?: "book_submitted_for_review" | "book_approved" | "book_rejected" | "book_unpublished" | "book_republished" | "book_deleted" | "publisher_enabled" | "publisher_disabled" | "user_role_changed" | "user_deleted" | "subscription_canceled" | "subscription_payment_failed" | "collection_created" | "collection_updated" | "collection_deleted" | "collection_book_added" | "collection_book_removed" | "collection_reordered" | "revenue_calculated"; subjectType?: "book" | "user" | "subscription" | "collection" | "revenue_period"; subjectId?: number } };
      responses: {
...
export interface components {
  schemas: {
    ...
    GetAdminPeriodEarningsResponseDto: { period: components['schemas']['RevenuePeriodResponse']; bookRevenues: Array<components['schemas']['BookRevenueResponse']>; total: number; authorCents: number; platformCutCents?: unknown | null };
    ...
    AdminInvitationResponse: { id: number; createdAt: string; updatedAt: string; email: string; status: "pending" | "accepted"; expiresAt: string; invitedByUserId: number; acceptedAt?: unknown | null };
